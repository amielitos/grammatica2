      ...
      appBar: CustomAppBar(
        ...
        onNotificationTap: () {
          showDialog(
            ...
            builder: (context) =>
                NotificationsDialog(userId: widget.currentUser.uid),
          );
        },
      ),
          ...
          child: LayoutBuilder(
            builder: (context, constraints) {
              final isWide =
                  ...
                  800; // Determine if it's wide screen layout
                            ...
                            children: [
                              ...
                              >(
                                ...
                                builder: (context, snapshot) {
                                  final data =
                                      snapshot.data?.data() ?? widget.educator;
                                  final avgRating =
                                                      ...
                                                      if (tier == 'Basic') {
                                                        ...
                                                        if (context.mounted) {
                                                          ScaffoldMessenger.of(
                                                            ...
                                                            const SnackBar(
                                                              content: Text(
                                                                'Successfully subscribed to Free Tier.',
                                                              ),
                                                            ),
                                                          );
                                                        }
                                                        ...
                                                        double amountInPhp =
                                                            amountInUSD *
                                                            56.0; // Conversion for QR PH demo
                                                        ...
                                                        if (success == true) {
                                                          ...
                                                          if (context.mounted) {
                                                            ScaffoldMessenger.of(
                                                              ...
                                                              SnackBar(
                                                                content: Text(
                                                                  'Payment Successful! You are now subscribed to $tier.',
                                                                ),
                                                              ),
                                                            );
                                                          }
      ...
      child: StreamBuilder<List<Review>>(
        ...
        builder: (context, snapshot) {
          ...
          final reviews = _starFilter == null
              ? allReviews
              : allReviews
                    .where((r) => r.rating.toInt() == _starFilter)
                    .toList();
                  ...
                  children: [
                    ...
                    Expanded(
                      child: Text(
                        _starFilter == null
                            ? 'No reviews yet.'
                            : 'No $_starFilter star reviews yet.',
                        style: const TextStyle(
                          fontSize: 16,
                          color: Colors.black87,
                          fontWeight: FontWeight.bold,
    ...
    showDialog(
      ...
      builder: (context) => StatefulBuilder(
        builder: (context, setDialogState) => Dialog(
          ...
          child: Container(
            width:
                440, // Limits the dialog so it doesn't take up the whole screen
                      ...
                      child: ElevatedButton(
                        onPressed: () async {
                          final review = Review(
                            ...
                            reviewerName:
                                widget.currentUser.displayName ?? 'Learner',
